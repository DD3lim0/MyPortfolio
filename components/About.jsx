            ...
            <section id='about' className="flex dark:bg-[rgb(16,22,37)] flex-col md:flex-row items-center w-full p-2 py-16" >
                <div className=" max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
                    <div className="col-span-2">
                        ...
                        <p className="py-2 dark:text-white text-gray-600">I specialize in building responsive fullstack web applications. I&apos;m passionate about learning new technologies and understand that there is more than one way to accomplish a task. My current focus is building applications that use React, Express, SQL and Node. I&apos;m a quick learner and can pick up new tech stacks as needed. I believe that being a great developer involves not sticking to one specific language but choosing the best tool for the job.</p>
                        <p className="py-2 dark:text-white text-gray-600">I&apos;ve spent the last 4 years in Information Technology as an IT Support Specialist. My desire in becoming a well-rounded Technologist has lead me to obtaining my CompTIA A+ and Security+. In my free time I enjoy spending time with my family, going outdoors, or physically staying active.</p>
