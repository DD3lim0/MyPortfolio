            ...
            <section id='about' className="flex dark:bg-[rgb(16,22,37)] flex-col md:flex-row items-center w-full p-2 py-16" >
                <div className=" max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
                    <div className="col-span-2">
                        ...
                        <p className="py-2 dark:text-white text-gray-600">Ive spent the last 4 years in Information Technology as an IT Support Specialist. My desire to becoming a well-rounded Technologist has lead me to obtaining my CompTIA A+, Security+, and Nework+.  When my computers turned off Im enjoying time with my family, the outdoors, or staying active.</p>
